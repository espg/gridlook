...
export function makeGpuProjectedPolygonMaterial(
  ...
  return new THREE.ShaderMaterial({
    uniforms: {
      ...
      // choropleth is off until updateGpuProjectedPolygonChoropleth enables it
 ...
 * scaleFactor normalization the grid materials use (a constant range lands
 * on the colormap midpoint).
 */
